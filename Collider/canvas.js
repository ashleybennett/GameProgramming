...
function onLoad() {
    ...
    function createBalls() {
        /* Ball takes X | Y | radius | Mass| vX | vY | colour | ColX | ColY */

        ballArray.push(new ball(50, 100, 20, 20, 1, 1, "white", null, null));
        ballArray.push(new ball(500, 100, 15, 15, -1, 1, "white", null, null));
        ballArray.push(new ball(300, 10, 12, 12, 1, 2, "white", null, null));
        ballArray.push(new ball(400, 250, 17, 17, -2, -1, "white", null, null));
        ballArray.push(new ball(430, 20, 18, 18, -2, 1, "white", null, null));

        ballArray.push(new ball(430, 70, 18, 18, -1, 1, "white", null, null));

        // large ball. 
        ballArray.push(new ball(400, 200, 30, 40, -2, 1, "white", null, null));
    }
