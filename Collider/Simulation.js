...
var Simulation = (function (Context) {
    ...
    function checkBallCollision(ball1, ball2) {
        ...
        if (distanceBetween < sumOfRadius) { // if the distance between them is less than the sum of radius they have collided.
            ...
            if (ball1.colour != "purple") {
                ball1.setColour("purple");
            }
            else {
                ball1.setColour("black");
            }
            if (ball2.colour != "black") {
                ball2.setColour("black");
            }
            else {
                ball2.setColour("purple");
            }
            ...
            ball1.setColX(collisionPointX);
            ball1.setColY(collisionPointY);
            ball2.setColX(collisionPointX);
            ball2.setColY(collisionPointY);
            return true;
        }
        else {
            return false;
